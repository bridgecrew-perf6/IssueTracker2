...
async function _processGetDiffs (params, options) {
  const { old = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> current = <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>} = params
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Sep 15 2020 07:28:07 GMT-0300 (GMT-03:00)
            </div>
        </div>
