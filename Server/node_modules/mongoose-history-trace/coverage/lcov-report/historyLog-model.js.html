...
module.exports.HistoryLogModel = function (options) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (process.env.NODE_ENV === 'test') historyLogModels = {}
&nbsp;
  const schemaObject = {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!(collectionName in historyLogModels)) {
