...
<head>
    <title>Code coverage report for plugin.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> plugin.js</h1>
        <div class='clearfix'>
 ...
 * }
 */
function HistoryPlugin (schema, options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
  /**
 ...
 */
function _mappedFieldsLog (doc = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
  const actions = {
...
async function _helperPreSave (result) {
  ...
  set(result, 'current', _toJSON(self.toObject ? self.toObject() : <span class="branch-1 cbranch-no" title="branch not covered" >self)</span>)
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isEmpty(query)) { <span class="cstat-no" title="statement not covered" >return console.warn(`Not found documents to ${result.method} history logs.`) </span>}
  const old = _toJSON(await self.findOne(query))
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isEmpty(old)) { <span class="cstat-no" title="statement not covered" >return console.warn(`Not found documents to ${result.method} history logs.`) </span>}
...
function _helperPosSaveWithDoc (result, doc) {
  if (result.method === 'created') {
    set(result, 'current', _toJSON(doc.toObject ? doc.toObject() : <span class="branch-1 cbranch-no" title="branch not covered" >doc)</span>)
  }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sun Sep 20 2020 11:04:37 GMT-0300 (GMT-03:00)
            </div>
        </div>
