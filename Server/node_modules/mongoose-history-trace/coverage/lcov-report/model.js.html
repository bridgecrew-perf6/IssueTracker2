...
<head>
    <title>Code coverage report for model.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> model.js</h1>
        <div class='clearfix'>
...
function getOptionsVersionInstance (mongooseInstance) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (version &lt; 5) {
<span class="cstat-no" title="statement not covered" >    return merge({}, { useMongoClient: true })</span>
  }
...
function getOrAddNewInstanceModel (mongooseInstance, collectionName, schema) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (mongooseInstance.models[collectionName]) {
<span class="cstat-no" title="statement not covered" >    return mongooseInstance.models[collectionName]</span>
  } else {
