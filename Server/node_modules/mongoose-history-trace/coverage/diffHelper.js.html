...
<head>
    <title>Code coverage report for diffHelper.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> diffHelper.js</h1>
        <div class='clearfix'>
...
const { set, get, map, omit, startCase, camelCase, compact, concat, isEmpty } = require('lodash')
